...
1. Proceda al llenado de los campos necesarios que a continuación se detallan.
    ...
    1. Seleccione el grupo de socio del negocio al que pertenezca el socio del negocio cliente que esta registrando, para este ejemplo el grupo utilizado es "**Clientes Nacionales**".
