...
Un socio del negocio empleado es aquella persona que presta sus servicios como trabajador en una determinada empresa, a continuación se define el proceso para la creación de socio del negocio empleado en ADempiere.
...
1. Proceda al llenado de los campos necesarios que a continuación se detallan.
    ...
    1. Seleccione el grupo al que pertenezca el socio del negocio que esta registrando, para este ejemplo el grupo utilizado es "**Empleados**".
